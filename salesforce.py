...
class SalesforceSampler(DashieSampler):
    def name(self):
        return 'salesforce'
    ...
    def sample(self):
        ...
        data = {
                "items":[{"label":"expected amount: {}".format(expected_amount),"value":""},
                        {"label":"forecast: {}{}{{}} v. {}".format(color,forecast,previous_forecast),"value":""},
                        {"label":"closed: {}{}{{}} v. {}".format(color1,closed,previous_closed),"value":""}]
               }
